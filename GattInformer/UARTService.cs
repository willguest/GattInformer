...
namespace GattInformer
{
    ...
    public class UARTService
    {
        ...
        public Guid SERVICE_UUID = new Guid("{0000dfb0-0000-1000-8000-00805f9b34fb}");
        private Guid TX_CHARACTERISTIC_UUID = new Guid("{0000dfb1-0000-1000-8000-00805f9b34fb}");
        private Guid RX_CHARACTERISTIC_UUID = new Guid("{0000dfb1-0000-1000-8000-00805f9b34fb}");
        ...
        private async Task ConfigureServiceForNotificationsAsync()
        {
            try
            {
                ...
                tx_characteristic = service.GetCharacteristicsForUuidAsync(new Guid("0000dfb1-0000-1000-8000-00805f9b34fb")).GetResults().Characteristics.First();
                rx_characteristic = service.GetCharacteristicsForUuidAsync(new Guid("0000dfb1-0000-1000-8000-00805f9b34fb")).GetResults().Characteristics.First();
